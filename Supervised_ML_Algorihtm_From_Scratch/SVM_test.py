...
model = SVC(C=100, gamma='auto', kernel='rbf').fit(data_train, data_train_target)
score = model.score(data_test, data_test_target)
print(f'scikit-learn SVM with gaussian kernel test score:{round(score * 100, 3)}%')
...
# scikit-learn polynomial kernel
model = SVC(C=100, gamma='auto', kernel='poly').fit(data_train, data_train_target)
score = model.score(data_test, data_test_target)
print(f'scikit-learn SVM with polynomial kernel test score:{round(score * 100, 3)}%')
...
# scikit-learn linear kernel
model = SVC(C=100, gamma='auto', kernel='linear').fit(data_train, data_train_target)
score = model.score(data_test, data_test_target)
print(f'scikit-learn SVM with linear kernel test score:{round(score * 100, 3)}%')
