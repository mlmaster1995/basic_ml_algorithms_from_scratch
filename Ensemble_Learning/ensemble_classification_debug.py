...
from Ensemble_classifier import EnsembleLearner
...
from Svm_classifier import Svm_Kernel
...
print(f'svm gaussian score:{round(score*100,3)}%')

# ensemble learning classifier
ensemble_clf = EnsembleLearner(data_train, data_train_target)
score = ensemble_clf.hard_volting_score(data_test, data_test_target, forests_clf, knn, lr_clf, nb_clf, svm_gaussian)
