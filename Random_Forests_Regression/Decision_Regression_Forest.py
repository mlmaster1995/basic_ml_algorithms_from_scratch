...
class RandomForest:
    ...
    def build_forests(self, dataset, dataset_target, tree_number=None, max_depth=2, max_features=None, random_subspaces=True,
...
class RegressionForest:
    ...
    # patches_ratio: to sample ratio percentage of dataset randomly
    # default tree_number is 100
    def build_forests(self, dataset, dataset_target, tree_number=None, max_depth=2, max_features=None, random_patches=True,
    ...
    # it's used in the parallel computing
    def _build_tree_advanced(self, dataset, dataset_target, max_depth, max_features, random_patches, patches_ratio, max_estimator):
        random.seed = 4
        feature_length = len(dataset[0])
        dataset_height = len(dataset)
        patches_height = int(dataset_height * patches_ratio)
